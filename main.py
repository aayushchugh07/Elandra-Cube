...
class ElandraCube:
    ...
    def __init__(self,keyspace="k1",tablename="t1",cassandra_host="localhost:9160",elasticsearch_seeds=['localhost:9200'],cube_details=None):
...
def test():# if __name__=="__main__":
	...
	#ecobj.makeCube()
	#ecobj.deleteCube()
	ecobj.insert({"fname":22,"lname":45})
